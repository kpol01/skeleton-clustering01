...
-   Given a metric $d$ on $\mathbb{R}^d$, the $2$-Nearest-Neighbor ($2$-NN) region of a pair of knots $\left(c_j,c_\ell\right)$ is defined as,
    ...
    -   $$ A_{j\ell}=\left\{\boldsymbol{x}\in \mathcal{X}:d\left(\boldsymbol{x},c_i\right)>\max\left\{d\left(\boldsymbol{x},c_i\right),d\left(\boldsymbol{x},c_\ell\right)\right\}\forall i\neq j,\ell\right\} $$
...
### Theorem (Voronoi Density Convergence)

Under the assumption of the above condition, for any pair $j\neq\ell$ that
shares an edge, the similarity measure based on the Voronoi density satisfies,
...
-   J.-P. Baudry, A. E. Raftery, G. Celeux, K. Lo, and R. Gottardo. Combining
    mixture components for clustering. Journal of Computational and Graphical
    Statistics, 19(2):332–353, 2010. doi: 10.1198/jcgs.2010.08111.

-   A. L. N. Fred and A. K. Jain. Combining multiple clusterings using evidence
    accumulation. IEEE Transactions on Pattern Analysis and Machine Intelligence,
    27(6):835–850, 2005. doi: 10.1109/TPAMI.2005.113.

-   R. Maitra. Initializing partition-optimization algorithms. IEEE/ACM Transactions
    on Computational Biology and Bioinformatics, 6(1):144–157, 2009. doi:
