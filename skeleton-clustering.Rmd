...
ggplot(as.data.frame(skeleton$centers), aes(V1,V2)) + stat_voronoi(geom = "path", lty = 2, col = "blue") +geom_point(data = data, col = 'darkgrey') + 
...
ggplot(data = cbind(data, X_lab_VD)) + geom_point(aes(V1, V2), col = X_lab_VD)+labs(x=TeX("$\\X_1$"),y=TeX("$\\X_2$"),title="Clusters obtained from the Skeleton")
